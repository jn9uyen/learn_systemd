...
install: $(service_dir) mypythonservice.service
	...
	@echo run "systemctl enable mypythonservice.service" to enable service
	@echo run "systemctl start mypythonservice.service" to start service
	@echo run "systemctl status mypythonservice.service" to view status
...
run:
	-systemctl enable mypythonservice.service
	-systemctl start mypythonservice.service
	-systemctl status mypythonservice.service